...
function ResetPassword() {
    ...
    const handleResetPassword = async(e)=>{
        e.preventDefault();
        try{
            const res = await axios.patch(`/auth/resetPassword/${token}`, {password,confirmPassword})
            ...
            <div className="login_container">
                <div className="login">
                    <form className="login_form">
                        ...
                        <button className='login_button' onClick={handleResetPassword}>Reset Password</button>
                        <p>
